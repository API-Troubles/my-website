    ...
    return {
        ...
        "blocks": [
            ...
            },
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": "_Usually these don't mean much (I likely was too lazy to code a proper menu for error handling). If the error does not contain troubleshooting steps, take a screenshot of this error and send it in #nest-management-bot :heavysob: I'm sorry (Canadian Edition apology)_"
                }
            },
            {
                "type": "image",
